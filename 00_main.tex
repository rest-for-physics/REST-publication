...
\title{REST-for-Physics, a ROOT-based framework for event oriented data analysis and combined MonteCarlo response.}

\collaboration{\includegraphics[height=24mm]{RESTlogoFull.png}}
